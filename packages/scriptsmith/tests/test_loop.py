...
from scriptsmith.loop import run_loop, should_stop
from scriptsmith.models import ProjectState
from scriptsmith.state import load_state, save_state
...
class TestRunLoop:
    ...
    def test_micro_respects_rounds(self, tmp_workspace: Path):
        ...
        state_path = tmp_workspace / ".scriptsmith" / "state.json"
