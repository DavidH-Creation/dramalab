...
from script_forge.models import ProjectState, ExperimentRecord, ScoreResult
...
class TestSaveLoadState:
    ...
    def test_atomic_no_temp_remains(self, tmp_workspace: Path):
        ...
        temps = list((tmp_workspace / ".script-forge").glob("*.tmp"))
        assert len(temps) == 0
...
class TestLock:
    def test_acquire_and_release(self, tmp_workspace: Path):
        ...
        lock_path = tmp_workspace / ".script-forge" / ".lock"
