# src/script_forge/cli.py
"""CLI entry point for Script-Forge."""
...
from script_forge import __version__
...
def init(
    ...
    """Initialize a new Script-Forge workspace."""
...
"""
    ...
    if backend is not None:
        ...
        try:
            ...
            console.print("  [yellow]Run 'script-forge derive' later to generate them.[/yellow]")
...
def run(
    ...
    from script_forge.workspace import validate_workspace
    ...
    if fresh:
        state_path = ws / ".script-forge" / "state.json"
...
def status(
    ...
    from script_forge.state import load_state
    from script_forge.workspace import validate_workspace
...
def score_cmd(
    ...
    from script_forge.workspace import load_criteria, load_sequence, validate_workspace
...
def main(
    ...
    if version:
        console.print(f"script-forge {__version__}")
        raise typer.Exit()
